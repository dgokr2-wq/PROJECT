...
"""
Учебная реализация блочного шифра по мотивам SAFER K-128.
Не предназначен для промышленного применения.

Особенности:
- симметричный алгоритм с 128-битным ключом;
- блок 64 бита, сеть Фейстеля с 10 раундами;
- нелинейность за счёт s-box функций exp/log в поле GF(257), как в SAFER;
